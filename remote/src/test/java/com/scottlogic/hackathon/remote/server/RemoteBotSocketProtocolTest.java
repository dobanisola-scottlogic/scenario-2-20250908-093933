...
@PrepareForTest({HeartBeat.class, Sender.class, GameStateBroker.class, MakeMovesBroker.class, TeamIdBroker.class,
        RemoteBot.class, RemoteBotSocketProtocol.class, ConnectionListener.class})
public class RemoteBotSocketProtocolTest {
    ...
    public void testCreateBot() throws Exception {
        ...
        ArgumentCaptor<ConnectionChangeEvent> eventArgumentCaptor = ArgumentCaptor.forClass(ConnectionChangeEvent.class);
        ...
        assertEquals(eventArgumentCaptor.getValue().getNewValue().getBot().getDisplayName(), team.getName(), team.getName());
    ...
    public void testStartHeartBeat() throws Exception {
        ...
        RemoteBotSocketProtocol protocol = new RemoteBotSocketProtocol(sender, Mockito.mock(ConnectionChangeSupport.class), turn);
        PowerMockito.whenNew(HeartBeat.class)
                .withAnyArguments().thenReturn(hb);
    ...
    public void testInitialise() throws Exception {
        ...
        FakeRemoteBotSocketProtocol protocol = new FakeRemoteBotSocketProtocol(sender, Mockito.mock(ConnectionChangeSupport.class), turn);
        RemoteBot remoteBot = PowerMockito.spy(new RemoteBot(new TeamId("team1", UniqueIdGenerator.INSTANCE.next()), turn));
    ...
    public void testSendMakeMoves() throws Exception {
        ...
        PowerMockito.mockStatic(GameStateBroker.class);
        PowerMockito.when(GameStateBroker.serialize(any())).thenReturn(SERIALIZED_GAMESTATE);
        RemoteBotSocketProtocol protocol = PowerMockito.spy(new RemoteBotSocketProtocol(sender, Mockito.mock(ConnectionChangeSupport.class), turn));
    ...
    public void testProcessMakeMoves() throws Exception {
        ...
        FakeRemoteBotSocketProtocol protocol = PowerMockito.spy(new FakeRemoteBotSocketProtocol(sender, Mockito.mock(ConnectionChangeSupport.class), turn));
        RemoteBot remoteBot = PowerMockito.spy(new RemoteBot(new TeamId("team1", UniqueIdGenerator.INSTANCE.next()), turn));
        protocol.setBot(remoteBot);
    ...
    class FakeRemoteBotSocketProtocol extends RemoteBotSocketProtocol {
        public FakeRemoteBotSocketProtocol(Sender sender, ConnectionChangeSupport changeSupport, Turn turn) {
