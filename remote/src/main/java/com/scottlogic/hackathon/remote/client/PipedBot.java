...
public class PipedBot extends Bot {
    ...
    private final static Logger logger =  LoggerFactory.getLogger(PipedBot.class);
    ...
    public PipedBot(String displayName, String cmd) throws IOException {
        ...
        Thread errorOutputThread = new Thread(errorReporter(new BufferedReader(new InputStreamReader(p.getErrorStream()))));
